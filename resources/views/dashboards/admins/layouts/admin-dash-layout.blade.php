      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{ route('users.dashboard')}}" class="nav-link {{ (request()->is('admin/dashboard*')) ? 'active' : '' }}">
               ...
               <li class="nav-item">
                <a href="{{ route('users.profile')}}" class="nav-link {{ (request()->is('admin/profile*')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('users.settings')}}" class="nav-link {{ (request()->is('admin/settings*')) ? 'active' : '' }}">
